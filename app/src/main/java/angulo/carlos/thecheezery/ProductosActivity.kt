...
class ProductosActivity : AppCompatActivity() {
    ...
    var productos2 = ArrayList<Product>()
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var adaptador: AdaptadorProductos= AdaptadorProductos(this,productos2)
        listview.adapter=adaptador
    }

    fun agregaProductos(){
        var categoria= intent.action
        var tipoProductos: ImageView= findViewById(R.id.tipoProducto) as ImageView
        when (categoria){
            "cold"-> {
                tipoProductos.setImageResource(R.drawable.colddrinks)
                coldDrinks.add(Product("Caramel Frap", R.drawable.caramelfrap, "Caramel syrup" +
                        " meets coffee, milk and ice and whipped cream and buttery caramel sauce layer the love on top.", 5.0))

                coldDrinks.add(Product("Chocolate Frap", R.drawable.chocolatefrap, "Rich mocha" +
                        "-flavored sauce meets up with chocolaty chips, milk and ice for a blender bash.", 6.0))

                coldDrinks.add(Product("Cold Brew", R.drawable.coldbrew, "Created by steeping"+
                        " medium-to-coarse ground coffee in room temperature water for 12 hours or longer.", 3.0))

                coldDrinks.add(Product("Matcha Latte", R.drawable.matcha, "Leafy taste of matcha " +
                        "green tea powder with creamy milk and a little sugar for a flavor balance that will " +
                        "leave you feeling ready and raring to go.", 4.0))

                coldDrinks.add(Product("Oreo Milkshake", R.drawable.oreomilkshake, "Chocolate " +
                        "ice cream, and oreo cookies. Topped with whipped cream with cocoa and chocolate syrup.", 7.0))

                coldDrinks.add(Product("Peanut Milkshake", R.drawable.peanutmilkshake, "Vanilla " +
                        "ice cream, mixed with peanut butter and chocolate.", 7.0))
                productos2=coldDrinks
            }
            "hot"->{
                tipoProductos.setImageResource(R.drawable.hotdrinks)
                ...
                productos2=hotDrinks
            }
            "sweets"->{
                tipoProductos.setImageResource(R.drawable.sweets)
            ...
            "salties"->{
                tipoProductos.setImageResource(R.drawable.salties)
